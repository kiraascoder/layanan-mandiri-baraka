...
<body>
    ...
    <div class="content">
        ...
        <p><strong>Alamat Asal:</strong> {{ $data_surat->alamat_asal }}</p>
        <p><strong>Alamat Tujuan:</strong> {{ $data_surat->alamat_tujuan }}</p>
        <p><strong>Alasan Pindah:</strong> {{ $data_surat->alasan_pindah }}</p>
        <p><strong>Jumlah Anggota:</strong> {{ $data_surat->jumlah_anggota }}</p>

        <p>Dengan ini, Pemerintah Desa XYZ memberikan <strong>Surat Keterangan Pindah Domisili</strong> ini
