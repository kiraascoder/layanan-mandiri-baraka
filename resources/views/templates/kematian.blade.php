...
<body>
    ...
    <div class="content">
        ...
        <p><strong>Nama Almarhum:</strong> {{ $data_surat->nama_almarhum }}</p>
        <p><strong>Tanggal Meninggal:</strong> {{ $data_surat->tanggal_meninggal }}</p>
        <p><strong>Sebab Meninggal:</strong> {{ $data_surat->sebab_meninggal }}</p>
        <p><strong>Tempat Meninggal:</strong> {{ $data_surat->tempat_meninggal }}</p>

        <p>Dengan ini, Pemerintah Desa XYZ memberikan <strong>Surat Keterangan Kematian</strong> ini
