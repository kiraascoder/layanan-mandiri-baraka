...
<body>
    ...
    <div class="content">
        ...
        <p class="indent" style="text-align: justify">Bahwa yang bersangkutan adalah benar warga Lingkungan
            {{ $data_surat->alamat }},
            Kelurahan Tomenawa, Kec. Baraka, Kabupaten Enrekang, yang berkelakuan baik dan benar mempunyai Usaha
            {{ $data_surat->nama_usaha }}</p>
        <p class="indent" style="text-align: justify">Demikian surat keterangan ini kami buat dan diberikan kepada yang
