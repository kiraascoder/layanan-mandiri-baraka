...
<body>
    ...
    <div class="content">
        ...
        <p class="indent" style="text-align: justify">Nama tersebut diatas adalah benar warga Lingkungan
            {{ $data_surat->alamat }}, Kelurahan
            Tomenawa,
            Kecamatan Baraka,
            Kabupaten Enrekang yang termasuk dalam kategori Keluarga Kurang Mampu (Pra Sejahtera).</p>
        <p class="indent" style="text-align: justify">Demikian Surat Keterangan ini dibuat dengan sebenar-benarnya untuk
            dapat
            digunakan dengan
            sebagaimana
            mestinya.</p>
